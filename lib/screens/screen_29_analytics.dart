          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: AssetImage(
                              'assets/images/screen29image1.jpg',
                            ),
                            fit: BoxFit.cover,
                          ),
                        ),
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.label.copyWith(
                          color: data.registrationTimelineChange.contains('-')
                              ? Colors.red
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.label.copyWith(
                          color: data.checkInTimelineChange.contains('-')
                              ? Colors.red
                              : AppColors.successGreen,
                          fontWeight: FontWeight.bold,
                        ),
                  ...
                  const SizedBox(height: 12),
                  ...data.registrationSources.map(
                    (source) => HorizontalProgressBar(
                      label: source.label,
                  ...
                  CustomButton(
                    ...
                    onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Comparison not available.'),
                      ),
                    ),
                  ),
                  const SizedBox(height: 24),
